    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="row icon-boxes">
        ...
        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="300">
          <div class="icon-box">
            <div class="icon"><img style="max-height: 65px;" src="<?= base_url(); ?>/assets/img/logo_lazismu.png" alt=""></div>
            <h4 class="title"><a href="https://lazismu.org/">Lazismu</a></h4>
            <p class="description">LAZISMU adalah lembaga zakat tingkat nasional yang berkhidmat dalam pemberdayaan masyarakat
              melalui pendayagunaan secara produktif dana zakat, infaq, wakaf dan dana kedermawanan lainnya baik dari perseorangan,
              lembaga, perusahaan dan instansi lainnya.</p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a href="">Peningkatan Kesejahteraan</a></h4>
              <p>Penanganan masalah sosial yang timbul akibat ekses external terhadap kehidupan mustahik, seperti bantuan bencana,
                pendampingan manula dan kegiatan karikatif</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <h4><a href="">Bantuan Kelembagaan</a></h4>
              <p>Penanganan kesejahteraan masyarakat melalui lembaga sosial, seperti panti asuhan, taman pembelajaran agama, dll</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <h4><a href="">Bantuan Kegiatan</a></h4>
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item">
            <p>
              ...
              Alhamdulillah dengan adanya Forum Kesejahteraan Rakyat membuat lebih mudah dalam pengajuan bantuan.
          ...
          <div class="testimonial-item">
            <p>
              <i class="bx bxs-quote-alt-left quote-icon-left"></i>
              Dengan adanya SipKe-Mas dana tersalurkan dengan jelas. Terima kasih SipKe-Mas
              <i class="bx bxs-quote-alt-right quote-icon-right"></i>
            </p>
